		...
		for (int i = 0; i < 69; i++) {
			...
			if ((bool)bitfield[i] == 1) {
				...
				if (telemetry_values[i].byte == 4) {
						...
						int32_t a = ((int8_t)buff_3_2[l += 3] << 24) + ((int8_t)buff_3_2[l -= 1] << 16) + ((int8_t)buff_3_2[l -= 1] << 8) + (int8_t)buff_3_2[l -= 1];
						cout << telemetry_values[i].value << ' = ' << a << endl;
						}
						else if (telemetry_values[i].type == "U32") {
						uint32_t b = ((uint8_t)buff_3_2[l += 3] << 24) + ((uint8_t)buff_3_2[l -= 1] << 16) + ((uint8_t)buff_3_2[l -= 1] << 8) + (uint8_t)buff_3_2[l -= 1];
						cout << telemetry_values[i].value << ' = ' << b << endl;
						}
						else if (telemetry_values[i].type == "Float") {
						float c = ((int8_t)buff_3_2[l += 3] << 24) + ((int8_t)buff_3_2[l -= 1] << 16) + ((int8_t)buff_3_2[l -= 1] << 8) + (int8_t)buff_3_2[l -= 1];
